export default {
    settings: {
      ...
      site: {
        ...
        accountResetTimeFormat: '账号配额重置时间格式',
        accountResetTimeFormatOptions: {
          full: '完整日期（2026-07-11 18:30）',
          short: '简短日期（07-11 18:30）',
          localized: '中文日期（2026年7月11日 18:30）',
          countdownOnly: '仅显示倒计时',
        },
      ...
      quotaNotify: {
        title: '账号配额提醒',
        description: '统一控制本地金额限额与 OpenAI 5h / 7d 剩余配额提醒',
        enabled: '启用账号配额提醒',
        emails: '通知邮箱',
        emailsHint: '留空则不发送通知',
        addEmail: '添加邮箱',
