export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      emailOnHit: 'Feishu on Hit/Risk',
      emailOnHitHint: 'When enabled, send Feishu risk-control alerts on every hit or risk state; email is sent only after auto-ban.',
      ...
      cleanupStats: 'Last cleanup deleted {hit} hits, {nonHit} non-hits, and {context} user-message contexts',
