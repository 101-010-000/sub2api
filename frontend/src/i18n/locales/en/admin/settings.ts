export default {
    settings: {
      ...
      site: {
        ...
        accountResetTimeFormat: 'Account quota reset time format',
        accountResetTimeFormatOptions: {
          full: 'Full date (2026-07-11 18:30)',
          short: 'Short date (07-11 18:30)',
          localized: 'Localized date (July 11, 2026 18:30)',
      ...
      quotaNotify: {
        title: 'Account Quota Alerts',
        description: 'Controls local spending limits and OpenAI 5h / 7d remaining quota alerts',
        enabled: 'Enable Account Quota Alerts',
