<template>
          ...
          <div class="mt-3 flex flex-wrap gap-4 text-xs text-gray-500">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :disabled="readOnly || updatingKeyIds.has(key.id)"
              >
                <GroupBadge
                ...
                <svg v-else-if="!readOnly" class="h-3 w-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 15L12 18.75 15.75 15m-7.5-6L12 5.25 15.75 9" /></svg>
              </button>
            </div>
  ...
  <Teleport to="body">
    <div
      v-if="!readOnly && groupSelectorKeyId !== null && dropdownPosition"
      ref="dropdownRef"
...
const props = defineProps<{ show: boolean; user: AdminUser | null; readOnly?: boolean }>()
