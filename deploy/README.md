...
curl -sSL https://raw.githubusercontent.com/TalexDreamSoul/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/TalexDreamSoul/sub2api/releases)
