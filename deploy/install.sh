...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/TalexDreamSoul/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="TalexDreamSoul/sub2api"
...
Documentation=https://github.com/TalexDreamSoul/sub2api
