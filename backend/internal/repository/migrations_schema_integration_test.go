...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "usage_logs", "speed_state", "text", 0, true)
	requireColumn(t, tx, "usage_logs", "speed_wait_ms", "integer", 0, false)
	requireColumn(t, tx, "usage_logs", "speed_route", "text", 0, true)
