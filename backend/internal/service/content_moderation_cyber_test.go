...
func (r *cyberOrderingTestRepo) CleanupExpiredLogs(ctx context.Context, hitBefore time.Time, nonHitBefore time.Time, contextBefore time.Time) (*ContentModerationCleanupResult, error) {
	return &ContentModerationCleanupResult{}, nil
}

func (r *cyberOrderingTestRepo) UpsertUserBan(ctx context.Context, ban *ContentModerationUserBan) error {
	return nil
}

func (r *cyberOrderingTestRepo) GetActiveUserBan(ctx context.Context, userID int64, now time.Time) (*ContentModerationUserBan, error) {
	return nil, nil
}

func (r *cyberOrderingTestRepo) ClearUserBan(ctx context.Context, userID int64, now time.Time) error {
	return nil
}

func (r *cyberOrderingTestRepo) CountSelfUnbanAttempts(ctx context.Context, userID int64, since time.Time) (int, error) {
	return 0, nil
}

func (r *cyberOrderingTestRepo) CreateSelfUnbanRecord(ctx context.Context, record *ContentModerationSelfUnbanRecord) error {
	return nil
}

func (r *cyberOrderingTestRepo) GetUserRiskProfile(ctx context.Context, userID int64) (*ContentModerationUserRiskProfile, error) {
	return nil, nil
}

func (r *cyberOrderingTestRepo) UpsertUserRiskProfile(ctx context.Context, profile *ContentModerationUserRiskProfile) error {
	return nil
}

func (r *cyberOrderingTestRepo) CreateUserRiskEvent(ctx context.Context, event *ContentModerationUserRiskEvent) error {
	return nil
}

func (r *cyberOrderingTestRepo) ListUserRiskEvents(ctx context.Context, userID int64, limit int) ([]ContentModerationUserRiskEvent, error) {
	return nil, nil
}

func (r *cyberOrderingTestRepo) CreateContext(ctx context.Context, item *ContentModerationContext) error {
	return nil
}

func (r *cyberOrderingTestRepo) ClaimPendingContexts(ctx context.Context, batchSize int) ([]ContentModerationContext, error) {
	return nil, nil
}

func (r *cyberOrderingTestRepo) UpdateContextReview(ctx context.Context, update ContentModerationContextReviewUpdate) error {
	return nil
}

func (r *cyberOrderingTestRepo) CountContextsByStatus(ctx context.Context) (*ContentModerationContextStatusCounts, error) {
	return &ContentModerationContextStatusCounts{}, nil
}

func (r *cyberOrderingTestRepo) ListUserContexts(ctx context.Context, userID int64, limit int) ([]ContentModerationContext, error) {
	return nil, nil
}

func (r *cyberOrderingTestRepo) GetContextByID(ctx context.Context, contextID int64) (*ContentModerationContext, error) {
	return nil, nil
}

func (r *cyberOrderingTestRepo) CreateContextAccessLog(ctx context.Context, contextID int64, adminUserID int64, action string) error {
	return nil
}
