...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, apiKeyService, subscriptionService, apiKeyRuntimeService, opsService, settingService, cfg, redisClient)
}
