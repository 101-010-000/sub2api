				...
				"data": [
					{
						...
						"default_fast_quota_ratio": 0,
						"min_fast_quota_ratio": 0,
						"max_fast_quota_ratio": 0,
						"default_slow_delay_min_seconds": 0,
						"default_slow_delay_max_seconds": 0,
			...
			wantJSON: `{
				...
				"data": {
					...
					"auth_source_default_linuxdo_platform_quotas": null,
						...
						"auth_source_default_feishu_platform_quotas": null,
					...
					"account_usage_reset_time_format": "full",
