...
type UsageLog struct {
	...
	// SpeedState holds the value of the "speed_state" field.
	SpeedState *string `json:"speed_state,omitempty"`
	// SpeedWaitMs holds the value of the "speed_wait_ms" field.
	SpeedWaitMs int `json:"speed_wait_ms,omitempty"`
	// SpeedRoute holds the value of the "speed_route" field.
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldID, usagelog.FieldUserID, usagelog.FieldAPIKeyID, usagelog.FieldAccountID, usagelog.FieldChannelID, usagelog.FieldGroupID, usagelog.FieldSubscriptionID, usagelog.FieldInputTokens, usagelog.FieldOutputTokens, usagelog.FieldCacheCreationTokens, usagelog.FieldCacheReadTokens, usagelog.FieldCacheCreation5mTokens, usagelog.FieldCacheCreation1hTokens, usagelog.FieldBillingType, usagelog.FieldDurationMs, usagelog.FieldFirstTokenMs, usagelog.FieldSpeedWaitMs, usagelog.FieldImageCount, usagelog.FieldVideoCount, usagelog.FieldVideoDurationSeconds:
			values[i] = new(sql.NullInt64)
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldSpeedState, usagelog.FieldSpeedRoute, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize, usagelog.FieldImageInputSize, usagelog.FieldImageOutputSize, usagelog.FieldImageSizeSource, usagelog.FieldVideoResolution:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldSpeedState:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field speed_state", values[i])
			} else if value.Valid {
				_m.SpeedState = new(string)
				*_m.SpeedState = value.String
			}
		case usagelog.FieldSpeedWaitMs:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field speed_wait_ms", values[i])
			} else if value.Valid {
				_m.SpeedWaitMs = int(value.Int64)
			}
		case usagelog.FieldSpeedRoute:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field speed_route", values[i])
			} else if value.Valid {
				_m.SpeedRoute = new(string)
				*_m.SpeedRoute = value.String
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.SpeedState; v != nil {
		builder.WriteString("speed_state=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	builder.WriteString("speed_wait_ms=")
	builder.WriteString(fmt.Sprintf("%v", _m.SpeedWaitMs))
	builder.WriteString(", ")
	if v := _m.SpeedRoute; v != nil {
		builder.WriteString("speed_route=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
