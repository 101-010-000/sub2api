...
func init() {
	...
	// apikeyDescMaxActiveIps is the schema descriptor for max_active_ips field.
	apikeyDescMaxActiveIps := apikeyFields[8].Descriptor()
	// apikey.DefaultMaxActiveIps holds the default value on creation for the max_active_ips field.
	apikey.DefaultMaxActiveIps = apikeyDescMaxActiveIps.Default.(int)
	// apikey.MaxActiveIpsValidator is a validator for the "max_active_ips" field. It is called by the builders before save.
	apikey.MaxActiveIpsValidator = apikeyDescMaxActiveIps.Validators[0].(func(int) error)
	// apikeyDescIPIdleTimeoutSeconds is the schema descriptor for ip_idle_timeout_seconds field.
	apikeyDescIPIdleTimeoutSeconds := apikeyFields[9].Descriptor()
	// apikey.DefaultIPIdleTimeoutSeconds holds the default value on creation for the ip_idle_timeout_seconds field.
	apikey.DefaultIPIdleTimeoutSeconds = apikeyDescIPIdleTimeoutSeconds.Default.(int)
	// apikey.IPIdleTimeoutSecondsValidator is a validator for the "ip_idle_timeout_seconds" field. It is called by the builders before save.
	apikey.IPIdleTimeoutSecondsValidator = apikeyDescIPIdleTimeoutSeconds.Validators[0].(func(int) error)
	...
	// usagelogDescSpeedWaitMs is the schema descriptor for speed_wait_ms field.
	usagelogDescSpeedWaitMs := usagelogFields[32].Descriptor()
	// usagelog.DefaultSpeedWaitMs holds the default value on creation for the speed_wait_ms field.
	usagelog.DefaultSpeedWaitMs = usagelogDescSpeedWaitMs.Default.(int)
	...
	// userDescAdminPermissions is the schema descriptor for admin_permissions field.
	...
	// userDescAPIKeyMaxActiveIps is the schema descriptor for api_key_max_active_ips field.
	userDescAPIKeyMaxActiveIps := userFields[22].Descriptor()
	// user.DefaultAPIKeyMaxActiveIps holds the default value on creation for the api_key_max_active_ips field.
	user.DefaultAPIKeyMaxActiveIps = userDescAPIKeyMaxActiveIps.Default.(int)
	// user.APIKeyMaxActiveIpsValidator is a validator for the "api_key_max_active_ips" field. It is called by the builders before save.
	user.APIKeyMaxActiveIpsValidator = userDescAPIKeyMaxActiveIps.Validators[0].(func(int) error)
	// userDescAPIKeyMaxActiveIpsVisible is the schema descriptor for api_key_max_active_ips_visible field.
	userDescAPIKeyMaxActiveIpsVisible := userFields[23].Descriptor()
	// user.DefaultAPIKeyMaxActiveIpsVisible holds the default value on creation for the api_key_max_active_ips_visible field.
	user.DefaultAPIKeyMaxActiveIpsVisible = userDescAPIKeyMaxActiveIpsVisible.Default.(bool)
